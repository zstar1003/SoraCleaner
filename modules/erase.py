...
def extract_mask(
    ...
    """
    Extracts masks from each frame based on the given frame paths and positions.

    Parameters:
    - frame_paths: A list of frame file paths.
    - positions: A list of target regions' positions, each represented as [xmin, ymin, xmax, ymax].
    ...
    for frame_path in tqdm(frame_paths, desc="Set Mask"):
        ...
        # Apply all watermark positions to the same mask
